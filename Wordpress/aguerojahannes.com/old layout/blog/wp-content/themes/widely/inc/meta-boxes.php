...
$meta_boxes = array(
    ...
    array(
        'id' => 'post_meta2',
        'title' => __('Slider Images', tk_theme_name()),
        'pages' => array('post'), // multiple post types
        'context' => 'normal',
        'priority' => 'high',
        'fields' => array(
        ...
        array(
        'id' => 'post_meta3',
        'title' => __('Page Headline', tk_theme_name()),
        ...
        array(
            'label' => 'Page Headline',
            'desc'  => '',
            'id'    => 'page_headline_link',
            'type'  => 'text',
            'name' => 'Page Headline Link',
            'value' => '',
            'std' => ''
        )
...
class My_meta_box {
    ...
    function show() {
        ...
        foreach ($this->_meta_box['fields'] as $field) {
            ...
            echo '<tr>',
                    '<th style="width:25%"><label for="', $field['id'], '"></label></th>',
                    '<td>';
            switch ($field['type']) {
