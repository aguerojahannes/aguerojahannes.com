...
function twentyten_setup() {
    ...
    add_image_size( 'main-thumbnail', 234, 190, true );
    add_image_size( 'big-thumbnail', 770, 539, true );
    add_image_size( 'big-blog-thumbnail', 770, 174, true );
...
function twentyten_widgets_init() {
	...
	// Area 2, located in the Blog Post Single View. Empty by default.
	register_sidebar( array(
		'name' => __( 'Blog Posts Sidebar', 'twentyten' ),
		'id' => 'blog-page-widget-area',
		'description' => __( 'The Blog Posts widget area', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
